...
/* TalentTie — Opportunity detail (B2), ported from opportunity-detail.jsx.
...
function ReasonBreakdown({ m }: { m: MatchVM }) {
  const rows = [
    ...
    { label: "Location", value: `${m.neighbourhood} · in London`, pct: Math.round(m.dimensions.location * 100), icon: "mapPin" },
